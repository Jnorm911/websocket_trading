...
file_path = f"data/kc/btc/heiken_ashi/with_trade_indicators/standard/kline/kc_btc_60min_ha_ti_pro.csv"
...
for model, accuracy in results.items():
    new_row = pd.DataFrame(
        {
            "model": [model],
            "duration": [60],  # Set the duration to 60 directly
...
print("Results for the single file appended to the DataFrame")
